                    ...
                    <Window title="physics" class="physics">
                        ...
                        <div class="videos">
                            <Window title="hatsune miku" buttons={1}>
                                <video controls={true}>
                                    <source src={format!("{SERVER_ADDRESS}/api/photography/physics-project/miku-hologram.mp4")} type="video/mp4"/>
                                </video>
                            </Window>
                            <Window title="vocaloid" buttons={1}>
                                <video controls={true}>
                                    <source src={format!("{SERVER_ADDRESS}/api/photography/physics-project/vocaloid-hologram.mp4")} type="video/mp4"/>
                                </video>
                            </Window>
                        </div>
                    </Window>
