...
<div class="aboutme">
  <x-navbar/>
  <x-decobar/>
  <x-window title="yapping about myself" class="main">        
      <div class="desc">
          <x-window title="woah" >
      ...
      <div class="favorite">
          ...
          <div class="content">
              <x-window title="films" class="film--list" >
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('i-saw-the-tv-glow-poster.jpg') }}" alt="I saw the TV Glow (2024) poster"/>
                      <p>I Saw the TV Glow (Jane Schoenbrun. 2024)</p>
                  </div>
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('civil-war-poster.jpg') }}" alt="Civil War (2024) poster"/>
                      <p>Civil War (Alex Garland. 2024)</p>
                  </div>
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('everything-everywhere-all-at-once-poster.jpg') }}" alt="Everything Everywhere All at Once (2022) poster"/>
                      <p>Everything Everywhere All at Once (Daniel Kwan and Daniel Scheinert. 2022)</p>
                  </div>
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('lady-bird-poster.jpg') }}" alt="Lady bird (2017) poster"/>
                  ...
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('a-silent-voice-poster.jpg') }}" alt="A Silent Voice (2016) poster"/>
                  ...
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('the-batman-poster.jpg') }}" alt="The Batman (2022) poster"/>
                      <p>The Batman (Matt Reeves. 2022)</p>
                  </div>
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('spiderman-across-the-spiderverse-poster.jpg') }}" alt="Spider-man Across the Spider-Verse (2023) poster"/>
                      <p>Spider-Man: Across the Spider-Verse (Joaquim Dos Santos, Kemp Powers and Justin K. Thompson. 2023)</p>
                  </div>
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('portrait-of-a-lady-on-fire-poster.jpg') }}" alt="Portrait of a Lady on Fire (2019) poster"/>
                      <p>Portrait of a Lady on Fire (Céline Sciamma. 2019)</p>
                  </div>
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('all-the-bright-places-poster.jpg') }}" alt="All the Bright Places (2020) poster"/>
                      <p>All the Bright Places (Brett Haley. 2020)</p>
                  </div>
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('the-perks-of-being-a-wallflower-poster.jpg') }}" alt="the perks of being a wallflower (2012) poster"/>
                      <p>the perks of being a wallflower (Stephen Chbosky. 2012)</p>
                  </div>
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('una-pelicula-de-policias-poster.jpg') }}" alt="una película de policías (2021) poster"/>
                      <p>Una película de policías (Alonso Ruizpalacios. 2021)</p>
                  </div>
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('temporada-de-patos-poster.jpg') }}" alt="temporada de patos (2004) poster"/>
                      <p>Temporada de patos (Fernando Eimbcke. 2004)</p>
                  </div>
                  <div class="film">
                      <img loading="lazy" src="{{ Vite::poster('cosas-imposibles-poster.jpg') }}" alt="Cosas Imposibles (2021) poster"/>
              ...
              <x-window title="series" class="series--list" >
                  ...
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('better-call-saul-poster.jpg') }}" alt="Better Call Saul poster"/>
                  ...
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('wonder-egg-priority-poster.jpg') }}" alt="Wonder Egg Priority poster"/>
                  ...
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('violet-evergarden-poster.jpg') }}" alt="Violet Evergarden poster"/>
                      <p>Violet Evergarden (Kana Akatsuki)</p>
                  </div>
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('blue-eye-samurai-poster.jpg') }}" alt="Blue Eye Samurai poster"/>
                      <p>Blue Eye Samurai (Michael Green and Amber Noizumi)</p>
                  </div>
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('looking-for-alaska-poster.jpg') }}" alt="Looking for Alaska poster"/>
                      <p>Looking for Alaska (Josh Schwartz)</p>
                  </div>
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('desenfrenadas-poster.jpg') }}" alt="Desenfrenadas poster"/>
                      <p>Desenfrenadas (Diego Martínez Ulanosky)</p>
                  </div>
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('baby-reindeer-poster.jpg') }}" alt="Baby Reindeer poster"/>
                      <p>Baby Reindeer ()</p>
                  </div>
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('the-owl-house-poster.jpg') }}" alt="The Owl House poster"/>
                      <p>The Owl House (Dana Terrace)</p>
                  </div>
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('star-vs-the-forces-of-evil-poster.jpg') }}" alt="Star vs The Forces of Evil poster"/>
                      <p>Star vs The Forces of Evil (Daron Nefcy, Dave Wasson and Jordana Arkin)</p>
                  </div>
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('helluva-boss-poster.jpg') }}" alt="Helluva Boss poster"/>
                      <p>Helluva Boss (Vivienne Medrano)</p>
                  </div>
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('hazbin-hotel-poster.jpg') }}" alt="Hazbin Hotel poster"/>
                  ...
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('bee-and-puppycat-poster.jpg') }}" alt="Bee and PuppyCat poster"/>
                  ...
                  <div class="series">
                      <img loading="lazy" src="{{ Vite::poster('the-last-of-us-poster.jpg') }}" alt="The Last of Us poster"/>
                      <p>The Last of Us (Neil Druckmann and Craig Mazin)</p>
                  </div>
              </x-window>
              <x-window title="videogames :3" class="game--list" >
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('the-last-of-us-game-poster.jpg') }}" alt="The Last of Us poster"/>
                      <p>The Last of Us</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('the-last-of-us-part-two-game-poster.jpg') }}" alt="The Last of Us: Part 2 poster"/>
                      <p>The Last of Us: Part II</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('red-dead-redemtion-two-poster.jpg') }}" alt="Red Dead Redemtion 2 poster"/>
                  ...
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('resident-evil-2-poster.jpg') }}" alt="Resident Evil 2 Remake poster"/>
                      <p>Resident Evil 2 Remake</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('resident-evil-4-poster.jpg') }}" alt="Resident Evil 4 poster"/>
                      <p>Resident Evil 4</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('resident-evil-6-poster.jpg') }}" alt="Resident Evil 6 poster"/>
                      <p>Resident Evil 6</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('resident-evil-7-poster.jpg') }}" alt="Resident Evil 7 Biohazard poster"/>
                      <p>Resident Evil 7: Biohazard</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('resident-evil-8-poster.jpg') }}" alt="Resident Evil 8 Village poster"/>
                  ...
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('metroid-prime-trilogy-poster.jpg') }}" alt="Metroid Prime Trilogy poster"/>
                      <p>Metroid Prime Trilogy</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('metroid-other-m-poster.jpg') }}" alt="Metroid Other M poster"/>
                      <p>Metroid: Other M</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('the-legend-of-zelda-oot-poster.jpg') }}" alt="The Legend of Zelda Ocarina of Time poster"/>
                      <p>The Legend of Zelda: Ocarina of Time</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('the-legend-of-zelda-ww-poster.jpg') }}" alt="The Legend of Zelda Wind Waker poster"/>
                      <p>The Legend of Zelda: Wind Waker</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('the-legend-of-zelda-botw-poster.jpg') }}" alt="The Legend of Zelda Breath of the Wild poster"/>
                      <p>The Legend of Zelda: Breath of the Wild</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('donkey-kong-64-poster.jpg') }}" alt="Donkey Kong 64 poster"/>
                      <p>Donkey Kong 64</p>
                  </div>
                  <div class="game">
                      <img loading="lazy" src="{{ Vite::poster('donkey-kong-country-returns-poster.jpg') }}" alt="Donkey Kong Country Returns"/>
              ...
              <x-window title="m u s i c" class="music--list" >
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('be-the-cowboy.jpg') }}" alt="Be the Cowboy album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Be the Cowboy by Mitski (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('bury-me-at-makeout-creek.jpg') }}" alt="Bury Me at Makeout Creek album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Bury Me at Makeout Creek by Mitski (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('damn.jpg') }}" alt="DAMN. album by Kendrick Lamar" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>DAMN. by Kendrick Lamar (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('mr-morale-and-the-big-steppers.jpg') }}" alt="Mr Morale and the big steppers album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Mr. Morale & The Big Steppers by Kendrick Lamar (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('hit-me-hard-and-soft.jpg') }}" alt="Hit me Hard and Soft album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>HIT ME HARD AND SOFT by Billie Eilish (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('sour.jpg') }}" alt="Sour album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Sour by Olivia Rodrigo (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('guts.jpg') }}" alt="Guts album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Guts by Olivia Rodrigo (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('delusion.jpg') }}" alt="Delusion album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Delusión de Bratty (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('tdbn.jpg') }}" alt="tdbn album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>tdbn de Bratty (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('otros-colores.jpg') }}" alt="Otros Colores single cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Otros Colores de Bratty y Daniel Quién (single)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('sobredosis-de-tempra.jpg') }}" alt="Sobredosis de Tempra single cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Sobredósis de Tempra de Bratty (single)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('axolotes-mexicanos.jpg') }}" alt=":3 album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>:3 de Axolotes Mexicanos (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('porfiado.jpg') }}" alt="Porfiado album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Porfiado de Cuarteto de Nos (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('blue-banisters.jpg') }}" alt="Blue Banisters album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Dealer by Lana del Rey (song)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('no-burden.jpg') }}" alt="No Burden album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>I Don't Wanna Be Funny Anymore by Lucy Dacus (song)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('home-video.jpg') }}" alt="Home Video album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Brando by Lucy Dacus (song)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('historian.jpg') }}" alt="Historian album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Night Shift by Lucy Dacus (song)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('bewitched.jpg') }}" alt="Bewitched album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Dreamer by Laufey (song)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('lumbreras.jpg') }}" alt="Lumbreras single cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Lumbreras de AQUILES (single)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('labour.jpg') }}" alt="Labour single cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>labour by Paris Paloma (single)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('1940-carmen.jpg') }}" alt="1940 Carmen album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>1940 Carmen de Mon Laferte (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('cabras.jpg') }}" alt="Cabras single cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Cabras de Little Jesus y Jimena Gonzáles (single)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('freshman-year.jpg') }}" alt="Freshman Year album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>freshman year by Hop Along, Queen Ansleis (album)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('dear-god.jpg') }}" alt="Dear God song cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Dear God by XTC (song)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('fin-de-semana.jpg') }}" alt="Fin de Semana song cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Fin de Semana de Sam Vazquez (cover)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('ccpseddh.jpg') }}" alt="¿Cuántas Cosas Podrían Sucederme El Día De Hoy? song cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>¿Cuántas Cosas Podrían Sucederme El Día De Hoy? de NXNNI, Sam Vazquez y Alehtse Vargas (single)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('visions-of-a-life.jpg') }}" alt="Visions of a Life album cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
                      <p>Don't Delete the Kisses by Wolf Alice (song)</p>
                  </div>
                  <div class="music">
                      <img loading="lazy" src="{{ Vite::music('cala-vento.jpg') }}" alt="Cala Vento cover" class="cover"/>
                      <img loading="lazy" src="{{ Vite::image('vinyl-disc.png') }}" alt="Vinyl disc" class="disc"/>
      ...
      <div class="social">
          <x-window title="shooting star" >
              <img loading="lazy" src="{{ Vite::image('last-words-of-a-shooting-star-sticker.jpg') }}" alt="Last Words of a Shooting Star, Mitski sticker"/>
          </x-window>
          <div class="content">
