...
@section('content')
    <div class="cameraroll">
        <x-navbar/>
        <x-decobar/>
        <x-window title="camera" class="main">
            <div class="title">
            ...
            <x-window title="me">
                ...
                <div class="photos">
                    ...
                    <div>
                        ...
                        <img loading="lazy"
                            src="{{ Vite::photo('vero/in-the-fucking-beach.jpg') }}" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <img loading="lazy"
                            src="{{ Vite::photo('vero/melanie-martinez-core.jpg') }}" />
                    </div>
                    <div>
                ...
                <h2>a couple pictures of my cat, milanesa <3</h2>
                        <div class="photos">
                            ...
                            <div>
                                ...
                                <img loading="lazy"
                                    src="{{ Vite::photo('milanesa/escritorio/1.jpg') }}" />
                                <img loading="lazy"
                                    src="{{ Vite::photo('milanesa/escritorio/2.jpg') }}" />
                            </div>
                        </div>
            </x-window>
            ...
            <x-window title="whiteboard">
                ...
                <div class="photos">
                    <div>
                        ...
                        <img loading="lazy"
                            src="{{ Vite::photo('pizarron/quadratic-formula.jpg') }}" />
                    </div>
                    <div>
                        <p>realizar integrales definidas utilizando la definición de Riemann es simplemente mágico ˚
                        </p>
                        <img loading="lazy"
                            src="{{ Vite::photo('pizarron/riemann-integral.jpg') }}" />
                    </div>
                </div>
            </x-window>
            ...
            <x-window title="frens">
                ...
                <div class="photos">
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('christmas-casa-de-jengibre/1.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('christmas-casa-de-jengibre/2.jpg') }}" />
                    </div>
                </div>
            </x-window>
            ...
            <x-window title="physics" class="physics">
                ...
                <div class="videos">
                    <x-window title="hatsune miku" >
                        <video controls={true}>
                            <source src="{{ Vite::photo('physics-project/miku-hologram.mp4') }}"
                                type="video/mp4" />
                        </video>
                    </x-window>
                    <x-window title="vocaloid" >
                        <video controls={true}>
                            <source src="{{ Vite::photo('physics-project/vocaloid-hologram.mp4') }}"
                                type="video/mp4" />
                        </video>
                    </x-window>
                </div>
            ...
            <x-window title="electromecánica">
                ...
                <div class="photos">
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('electromecanica-visita/1.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('electromecanica-visita/2.jpg') }}" />
                    </div>
                </div>
            </x-window>
            ...
            <x-window title="ensenada">
                ...
                <div class="photos">
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('ensenada-travel/electrical-tower.jpg') }}" />
                    </div>
                    <div>
                    ...
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('ensenada-travel/road-signs.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('ensenada-travel/long-road.jpg') }}" />
                    </div>
                </div>
            </x-window>
            <x-window title="palacio cultural">
                ...
                <div class="photos">
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/palacio-de-la-cultura.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/internet-reality.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/feelings-puppets.jpg') }}" />
                    </div>
                    <div>
                        <p>odio.</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/feelings-puppets--odio.jpg') }}" />
                    </div>
                    <div>
                        <p>el centro</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/el-centro.jpg') }}" />
                    </div>
                    <div>
                        <p>policia municipal</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/policia-municipal.jpg') }}" />
                    </div>
                    <div>
                        <p>esto si es America.</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/esto-si-es-america.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/identidad-cultural-del-pueblo.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/mirror-painting/1.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/mirror-painting/2.jpg') }}" />
                    </div>
                    <div>
                        <p>odio bordar</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/odio-bordar/1.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/odio-bordar/2.jpg') }}" />
                    </div>
                    <div>
                        <p>the truth is in love</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/the-truth-is-in-love/1.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('palacio-cultural/the-truth-is-in-love/2.jpg') }}" />
                    </div>
                </div>
            </x-window>
            <x-window title="home">
                ...
                <div class="photos">
                    ...
                    <div>
                        ...
                        <img loading="lazy"
                            src="{{ Vite::photo('home/swear-to-me-its-true.jpg') }}" />
                    </div>
                    <div>
                        <p>
                    ...
                    <div>
                        ...
                        <img loading="lazy"
                            src="{{ Vite::photo('home/progress-but-still-a-lot-to-do.jpg') }}" />
                    </div>
                </div>
            </x-window>
                ...
                <div class="photos">
                    ...
                    <div>
                        <p>i'm typing you a message that i know i'll never send, rewriting old excuses, delete the kisses
                            at the end</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('plants/dont-delete-the-kisses-flowers/1.jpg') }}" />
                    </div>
                    <div>
                        <p>xoxo ♡</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('plants/dont-delete-the-kisses-flowers/2.jpg') }}" />
                    </div>
                    <div>
                        <p>
                        ...
                        <img loading="lazy"
                            src="{{ Vite::photo('plants/dont-say-you-love-me.jpg') }}" />
                    </div>
                    <div>
                    ...
                    <div>
                        <p>~ preludio ~</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('plants/sunflower-letter/1.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('plants/sunflower-letter/2.jpg') }}" />
                    </div>
                </div>
            </x-window>
            <x-window title="landscapes">
                ...
                <div class="photos">
                    <div>
                        <p>sunset</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('landscapes/beach-sillhoutte.jpg') }}" />
                    </div>
                    <div>
                        <p>ferris wheel</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('landscapes/fair-ferris-wheel.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('landscapes/home-lighthouse.jpg') }}" />
                    </div>
                    <div>
                        <p>
                        ...
                        <img loading="lazy"
                            src="{{ Vite::photo('landscapes/house-with-radio-tower.jpg') }}" />
                    </div>
                    <div>
                        <p>we're all small and stupid</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('landscapes/just-be-a-rock.jpg') }}" />
                    </div>
                    <div>
                    ...
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('landscapes/ocean-paper-cutout.jpg') }}" />
                    </div>
                    <div>
                        <p>32° 2' 34\" N 115° 54' 24\" W</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('landscapes/snow-travel--landscape.jpg') }}" />
                    </div>
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('landscapes/snow-travel--trees.jpg') }}" />
                    </div>
                    <div>
                        <p>⎯⎯ ୨ wandering ୧ ⎯⎯ creo que he perdido la página</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('landscapes/yellow-sunset.jpg') }}" />
                    </div>
                    <div>
                        <p>capitulo 6; loveless</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('landscapes/i-see-you-island.jpg') }}" />
                    </div>
                    <div>
                        <p>
                        <p>❜ ─ párrafos, cambio ─ ❛</p>
                        ...
                        <img loading="lazy"
                            src="{{ Vite::photo('landscapes/house-with-water-well.jpg') }}" />
                    </div>
                </div>
            </x-window>
            <x-window title="photo mode">
                ...
                <div class="photos">
                    ...
                    <div>
                        <p>we tortured</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('photo-mode/choked-on-their-own-blood.jpg') }}" />
                    </div>
                    <div>
                        <p>wept.</p>
                        <img loading="lazy"
                            src="{{ Vite::photo('photo-mode/the-last-one-cried.jpg') }}" />
                    </div>
                    <div>
                    ...
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('photo-mode/dina-and-ellie.jpg') }}" />
                    </div>
                    <div>
                        <p>Umbrella.</p>
            ...
            <x-window title="other">
                ...
                <div class="photos">
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('amar-es-todo-lo-que-tengo.jpg') }}" />
                    </div>
                    <div>
                    ...
                    <div>
                        <img loading="lazy"
                            src="{{ Vite::photo('school-onestep-polaroid.jpg') }}" />
                    </div>
                    <div>
                        <p>tqm mucho &gt;3</p>
