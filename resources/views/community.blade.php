...
<main class="min-h-svh w-screen p-2 grid grid-rows-[auto_1fr_auto] gap-2 bg-background-primary">
    ...
    <section class="px-2 flex flex-wrap justify-center md:gap-4 gap-2 content-center max-w-3xl mx-auto">
    @forelse ($users as $user)
    <a
        href="{{ route('profile', $user->id) }}"
        class="md:w-36 w-24 p-2 h-fit flex flex-col gap-1 items-center hover:outline-2 hover:outline-dashed hover:outline-foreground/10 cursor-pointer"
    >
